...
namespace CarSharing.getCarDetails
{
    public static class getCarDetails
    {
        ...
        public static async Task<HttpResponseMessage> Run([HttpTrigger(AuthorizationLevel.Anonymous, "get", "post", Route = null)]HttpRequestMessage req, TraceWriter log)
        {
            ...
            string get_car_query =  "SELECT Vehicles.id as id, Devices.lat, Vehicles.year, Devices.lng, Users.FirstName as owner_first_name, Users.LastName as owner_last_name, "
